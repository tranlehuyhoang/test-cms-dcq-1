                        ...
                        <form method="post" id="task_form" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ route('user.update') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="" class="form-control" name="user[name]" value="<?php echo $user[0]['name']?>">
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label">{{ __('messages.user_email') }}</label>
                                    <input type="email" class="form-control" aria-describedby="emailHelp" name="user[email]" value="<?php echo $user[0]['email']?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="password" class="form-control" name="user[re_password]" value="">
                                </div>
                            </div>
